...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Admin'), array('action' => 'delete', $admin['Admin']['admin_id']), null, __('Are you sure you want to delete # %s?', $admin['Admin']['admin_id'])); ?> </li>
